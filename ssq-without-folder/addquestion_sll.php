...
if(isset($_POST['submit'])){
		...
		//Question query
		$query = "INSERT INTO `sll_questions`(question_number, text)
		...
		if($insert_row){
			foreach($choices as $choice => $value){
				if($value != ''){
					...
					//Choice query
					$query = "INSERT INTO `sll_choices` (question_number, is_correct, text)
...
$query = "SELECT * FROM `sll_questions`";
	//Get The Results
...
<div class="col-md-3"></div><div class="col-md-6">   <form class="form-horizontal title1" name="form" method="POST" action="addquestion_sll.php">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="correct_choice" name="correct_choice" placeholder="Enter the correct option" class="form-control input-md" min="1" max="5" type="number" required> 
  </div>
</div>
