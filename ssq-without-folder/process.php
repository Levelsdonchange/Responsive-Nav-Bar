...
<div class="container">
	...
	<main>
<div class="panel" style="margin:0% 20% 10% 20%; background-color: #f3f3f3;">
<?php
    ...
    $name=$_SESSION['name'];    
    mysqli_query($con,"INSERT INTO history VALUES('$name','$email','lost','0',NOW())")or die('Error');    
...
<?php   
    ...
    if($_POST){
        ...
        if ($selected_choice == 1)   
        {
            $email=$_SESSION['email'];
            $name=$_SESSION['name'];
            mysqli_query($con,"INSERT INTO history VALUES('$name','$email','won','0',NOW())")or die('Error');
        ...
        else
        {
            ...
            $name=$_SESSION['name'];
            mysqli_query($con,"INSERT INTO history VALUES('$name','$email','lost','0',NOW())")or die('Error');
            echo "<center><h2>Sorry That's Incorrect </h2></center>";
